...
import { authenticateToken, checkJSONBody, checkRequestValidity, isValidEmail, isValidUrl, testUrlAccessibility, userMustExist, userMustNotExist } from '../../utils/validations.mjs';
...
describe('Test validation functions', () => {
    ...
    describe('authenticateToken', () => {
        ...
        const user = { userId: 100, username: 'testUser', email: 'test@example.com' };
